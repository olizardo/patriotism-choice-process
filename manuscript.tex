...
An initial examination of the binary items comprising the U.S. Pride scale confirms a substantial period effect between 1996 and 2004. Survey-weighted logistic regressions indicate that the likelihood of respondents reporting being ``very proud'' of the United States significantly increased across nearly all measured domains (see Figure \ref{fig:logistic_pride}). Notably, pride in America's armed forces, history, and fair treatment of all groups saw dramatic increases post-9/11. The overall distribution of the U.S. Pride scale shifted markedly upward in 2004 compared to 1996 (see Figure \ref{fig:pride_boxplot}).
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{Plots/fig-pride-boxplot.pdf}
\caption{U.S. Pride Scale Score by Year}
\label{fig:pride_boxplot}
\end{figure}
