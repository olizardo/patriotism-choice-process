...
All models include statistical controls for birth cohort (centered at 1955) and political ideology. Political ideology is measured using the standard GSS 7-point scale ranging from 1 (``Extremely liberal'') to 7 (``Extremely conservative''), centered at 4 (moderate). An indicator variable for missing political ideology is also included to retain respondents who did not answer this question. The 2004 cross-sectional models additionally control for gender, race, and geographic region.
