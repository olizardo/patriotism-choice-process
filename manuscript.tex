...
Turning to the U.S. Pride scale under the Choice-Process framework, we compare the effects of education across the two periods. OLS models reveal a striking reversal. As shown in the first model of table xxx, 1996, education was negatively associated with national pride, supporting the hypothesis that low-status individuals are more likely to feel such pride. However, as we can see in the second model in the same table, the coefficient estimate in 2004 is positive but not significant at conventional levels. A pooled model that formally tests the interaction between education and the survey year shows a significant positive interaction term, suggesting that national pride increased at a faster rate among higher-educated individuals \textit{after} 9/11. 
